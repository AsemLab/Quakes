...
✨**Quakes** demonstrates modern Android development with Google Maps SDK, Firebase, Hilt, Coroutines, Flow, Jetpack libraries(Navigation component, Room, ViewModel, Paging3) based on MVVM architecture.
